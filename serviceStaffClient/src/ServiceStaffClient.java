...
public class ServiceStaffClient extends JFrame implements Command {
    // Default Fonts
    ...
    public void Scanning() throws MalformedURLException, NotBoundException, RemoteException {
        ...
        OverallInfo.setText("");
        FilteredInfo.setText("To be cleaned:\n\n");
        if(ID[0]==-1){
        ...
        for(int i=0;i<100;i++){
            try{
                ...
                observers.put(count,new ServiceStaff(count-1,ID[0]));
                roomList.addItem(count);
                if(server.StateStr().equals("Needs Cleaning"))FilteredInfo.append("Location "+count+": "+server.ToString()+"\n");
    ...
    private HashMap<Integer,ServiceStaff> observers=new HashMap<>();
        ...
        switch (com[0]){
            ...
            case "about":{
                if(com.length>=2&&com[1].equals("love")){
                    new MessageBox("Love is invaluable.\n\nRoom Management System (Service Staff Client)\nversion "+version+"\n(C)Vincent C. All rights reserved.",400,240).setVisible(true);
                }
                else new MessageBox("Room Management System (Service Staff Client)\nversion "+version+"\n(C)Vincent C. All rights reserved.",400,240).setVisible(true);
                break;
            }
            case "nihao":{
                System.out.println("""
        ...
        registerButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    check=new ServiceStaff("rmi://127.0.0.1:1099/Remote0",ID[0]);
